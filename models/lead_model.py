...
class LeadModel(BaseModel):
    ...
    # Implementación simplificada para el formulario resumido
    def create_lead(self, telefono: str, origen: str, vendedor: str, nombre_pasajero: str = "") -> Optional[int]:
    ...
    def find_by_phone(self, telefono: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"Error al buscar lead por teléfono: {e}")
            return None
