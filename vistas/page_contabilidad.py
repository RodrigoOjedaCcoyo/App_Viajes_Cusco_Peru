...
def render_itinerary_simple_download(render, id_venta=None, supabase_client=None):
    ...
    with st.container(border=True):
        ...
        with c1:
            ...
            pdf_buffer = pdf_ctrl.generar_itinerario_simple_pdf(render, id_venta=id_venta, supabase_client=supabase_client)
            if pdf_buffer:
                st.download_button(
            ...
            if id_it_dig:
                with st.expander("📄 Ver Itinerario Original para Auditoría", expanded=False):
                    ...
                    if res_it.data:
                        ...
                        render_itinerary_simple_download(render_data, id_venta=v_act['id_venta'], supabase_client=controller.client)
                        st.markdown("---")
